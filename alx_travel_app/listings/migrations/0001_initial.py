    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listing_host', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('amenity_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(choices=[('WI-FI', 'wi-fi'), ('POOL', 'Pool'), ('PETS', 'Pets'), ('GYM', 'Gym'), ('PARKING', 'Parking')], max_length=10)),
                ('qty', models.IntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='amenity', to='listings.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('guest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to=settings.AUTH_USER_MODEL)),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bookings', to='listings.listing')),
            ],
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('end_date__gt', models.F('start_date'))), name='check_start_date')],
            },
        ),
        migrations.CreateModel(
            name='Review',
